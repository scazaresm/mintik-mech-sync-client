...
{
    public class TransferVersionOwnershipHandler
    {
        private readonly HttpClient client;
        private readonly TransferVersionOwnershipRequest request;

        public TransferVersionOwnershipHandler(HttpClient client, TransferVersionOwnershipRequest request)
        {
            ...
            return await Policy
                ...
                .ExecuteAsync(async () =>
                {
                    ...
                    HttpResponseMessage response = await client.PostAsync(
                        "versions/ongoing/ownership/transfer",
